...
Pod::Spec.new do |s|
  s.name             = 'PratikPods13'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PratikPods13.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/hbsameer/PratikPods13'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'hbsameer' => 'pratik.panchal@indianic.com' }
  s.source           = { :git => 'https://github.com/hbsameer/PratikPods13.git', :tag => s.version.to_s }
